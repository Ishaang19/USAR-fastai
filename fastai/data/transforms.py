...
# Try to sort numerically if all items are numeric strings or numbers 

try: 

items = items.sorted(key=lambda x: float(str(x)) if x is not None else float('inf')) 

except (ValueError, TypeError): 

# Fall back to default string sorting if items aren't numeric 
