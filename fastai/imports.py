...
"Failed to import scipy.ndimage due to numpy/scipy version incompatibility. " 

"This is usually caused by incompatible versions of numpy and scipy in your environment.\n\n" 

"To fix this issue, try:\n" 

"1. Update both packages: pip install --upgrade numpy scipy\n" 

"2. Or reinstall scipy: pip uninstall scipy && pip install scipy\n" 

"3. If using conda: conda update numpy scipy\n\n" 
